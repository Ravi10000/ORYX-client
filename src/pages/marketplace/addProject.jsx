...
export default function AddProject() {
  ...
  async function getProjectType() {
    const {
      data: { data },
    } = await api.get("/project-type/read");
    // console.log(data);
  ...
  async function createProject(data) {
    ...
    if (project) {
      try {
        const res = await api.putForm(`/project/update/${project?._id}`, {
          ...data,
          images,
        });
      ...
      try {
        const res = await api.postForm("/project/create", {
          ...data,
          images,
        });
        // console.log(res.data);
  ...
  return (
    <>
      ...
      <div className="bg-white flex flex-col shadow-2xl rounded-lg my-2 lg:m-10 py-5 lg:py-10">
        <div className="pb-10">
          <h2 className="lg:py-3 px-5 lg:px-10 text-lg bg-bodyBg font-semibold">
            Project 101
          </h2>
        </div>
            ...
            <div className="flex-1 flex flex-col gap-5 lg:w-[50%]">
              ...
              <div className="flex flex-col gap-1">
                ...
                >
                  ...
                  <option value="DevelopmentCompleted">
              ...
              <div className="flex flex-col gap-1">
                <label htmlFor="weekly" className="font-medium">
                  Weekly Withraw Limit
                </label>
                <input
                  {...register("weeklyWithrawLimit")}
                  type="text"
                  id="weekly"
                  className="py-2 bg-[#f7fbff] border-2 border-[#ebeff3] outline-primary rounded-lg"
                />
              ...
              <div className="flex flex-col gap-1">
                <label htmlFor="propertyType" className="font-medium">
                  Monthly Withraw Limit
                </label>
                <input
                  {...register("monthlyWithrawLimit")}
                  type="text"
                  id="pincode"
                  className="py-2 bg-[#f7fbff] border-2 border-[#ebeff3] outline-primary rounded-lg"
                />
              ...
              <div className="flex flex-col gap-1">
                <label htmlFor="propertyType" className="font-medium">
                  Annual Withraw Limit
                </label>
                <input
                  {...register("annualWithrawLimit")}
                  type="text"
                  id="pincode"
                  className="py-2 bg-[#f7fbff] border-2 border-[#ebeff3] outline-primary rounded-lg"
                />
            ...
            <div className="flex-1 lg:w-[50%]">
              <div {...getRootProps({ className: "dropzone" })}>
                ...
                <div className="flex flex-col gap-1 relative cursor-pointer">
                  <h5 htmlFor="image" className="font-medium">
                    Images
                  </h5>
                  <div className="border-2 border-[#eef2f6] bg-[#f7fbff] max-w-80 h-20 flex justify-center items-center outline-primary rounded-lg">
                    <div className="flex justify-center items-center gap-2 p-2">
                      <img src="/upload.png" alt="upload" className="w-4 h-4" />
